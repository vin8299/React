...
const mapDispatchToProps = (dispatch) => ({
    ...
    postFeedback : (firstname, lastname, telnum, contactType, email, agree,message) => dispatch(postFeedback(firstname, lastname, telnum, contactType, email, agree,message)),
